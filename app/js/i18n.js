...
const TEXTOS = {
  ca: {
    ...
    "carta.preuAproximat": "Preu aproximat: convertit dels dòlars de TCGplayer (Cardmarket encara no en té)",
    ...
    "estad.preusAproximats": "inclou preus aproximats (≈): {n}",
    "zoom.tancar": "Tanca el zoom",
    "zoom.ajuda": "Toca fora o prem Esc per tancar",
    "zoom.ajudaTactil": "Toca fora o el × per tancar",
    ...
    "marcar.ajudaTocLlarg": "Mantén el dit sobre una carta per veure-la en gran",
    ...
    "expansions.tancar": "Tanca el selector d'expansions",
    "filtres.boto": "Filtres i opcions",
  },
  es: {
    "idioma.etiqueta": "Idioma",
    ...
    "carta.preuAproximat": "Precio aproximado: convertido de los dólares de TCGplayer (Cardmarket aún no lo tiene)",
    ...
    "estad.preusAproximats": "incluye precios aproximados (≈): {n}",
    "zoom.tancar": "Cerrar el zoom",
    "zoom.ajuda": "Toca fuera o pulsa Esc para cerrar",
    "zoom.ajudaTactil": "Toca fuera o la × para cerrar",
    ...
    "marcar.ajudaTocLlarg": "Mantén el dedo sobre una carta para verla en grande",
    ...
    "expansions.tancar": "Cierra el selector de expansiones",
    "filtres.boto": "Filtros y opciones",
  },
  en: {
    ...
    "carta.preuAproximat": "Approximate price: converted from TCGplayer dollars (Cardmarket does not have it yet)",
    ...
    "album.indicadorSola": "Page {n} of {total}",
    "album.anterior": "Previous spread",
    "album.seguent": "Next spread",
    "album.restar": "Remove one copy",
    ...
    "estad.preusAproximats": "includes approximate prices (≈): {n}",
    "zoom.tancar": "Close zoom",
    "zoom.ajuda": "Tap outside or press Esc to close",
    "zoom.ajudaTactil": "Tap outside or the × to close",
    ...
    "marcar.ajudaTocLlarg": "Press and hold a card to view it large",
    ...
    "expansions.tancar": "Close the expansion selector",
    "filtres.boto": "Filters and options",
  },
};
